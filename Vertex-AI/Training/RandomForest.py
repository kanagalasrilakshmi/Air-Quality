...
class RandomForestPM25Model:
    ...
    def save_weights(self):
        ...
        bucket_name = "airquality-mlops-rg"
        model_blob_path = "weights/randomforest_pm25_model.pth"  # Path in the bucket where the model will be saved
...
def main():
    ...
    model_save_path_gcs = f'gs://{bucket_name}/weights/randomforest_pm25_model.pth'
