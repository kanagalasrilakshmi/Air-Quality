...
def bias_main():
    ...
    input_path = os.environ.get("BIAS_CHECK_INPUT_PATH")
    save_path = os.environ.get("BIAS_CHECK_OUTPUT_PATH")
    sensitive_feature = os.environ.get("BIAS_CHECK_SENSITIVE_FEATURE", "month")
    threshold = float(os.environ.get("BIAS_CHECK_THRESHOLD", 0.2))

    analysis = PM25Analysis(input_path)
