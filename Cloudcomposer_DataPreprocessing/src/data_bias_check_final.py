...
def bias_main():
    # Get the file paths from environment variables or default them
    input_path = os.getenv('BIAS_CHECK_INPUT_PATH', 'gs://your-bucket-name/air_pollution.pkl')
    save_path = os.getenv('BIAS_CHECK_OUTPUT_PATH', 'gs://your-bucket-name/resampled_data.pkl')
