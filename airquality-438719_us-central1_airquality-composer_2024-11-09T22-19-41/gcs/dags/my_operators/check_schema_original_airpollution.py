...
def main_generate_schema_and_statistics():
    ...
    # Load dataset into a DataFrame using a byte stream
    data_bytes = blob.download_as_bytes()  # Get file bytes
    data = pd.read_pickle(io.BytesIO(data_bytes))  # Read bytes as DataFrame
